...
export default function Header() {
  return (
    <header className="xs:flex-row mt-3 flex w-full flex-col items-center justify-between gap-2 border-b border-gray-500 px-2 pb-7 sm:px-4">
      ...
      <a
        className="flex max-w-fit items-center justify-center space-x-2 rounded-full border border-emerald-600 bg-emerald-600 px-5 py-2 text-sm font-medium text-white shadow-md transition hover:bg-emerald-500"
